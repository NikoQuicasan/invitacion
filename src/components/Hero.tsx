...
export default function Hero() {
  return (
    <section className={clsx('relative', 'w-full', 'h-[100dvh]', 'flex', 'flex-col', 'items-center', 'justify-center', 'text-center', 'overflow-hidden')}>
      ...
      {/* Overlay con degradado, más elegante que un negro plano */}
      <div className={clsx('absolute', 'inset-0', 'bg-gradient-to-b', 'from-black/45', 'via-black/15', 'to-black/55')} />

      {/* Detalles florales en las esquinas para quitarle lo plano */}
      ...
      {/* Textos */}
      <div className={clsx('relative', 'z-20', 'flex', 'flex-col', 'items-center', 'text-crema', 'mt-[-10vh]')}>
        ...
        {/* Fecha con separadores decorativos en vez de texto plano */}
